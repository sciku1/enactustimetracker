<?php 
session_start();
if (($_SESSION["loggedin"] !== true ) || ($_SESSION["priviledge"] < 2)) {
...
<div id="container" class="container">
	...
	<a class="button" href="src/usersToCsv.php">Download Spreadsheet</a>
</div>
<script type="text/javascript" src="js/projectSummaries.js"></script>
</html>